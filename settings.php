...
/**
 * Adiciona o plugin na Administração do Site
 *
 * @package    tool
 * @subpackage datacert
...
$ADMIN->add('users', new admin_externalpage('tooldatacert', get_string('pluginname', 'tool_datacert'), "$CFG->wwwroot/$CFG->admin/tool/datacert/index.php"));
